...
void setupControls() {
  ...
  //System.out.println("VurfEclipse#setupControls got controlWindow " + controlWindow);
    
  /*controlWindow.addTab("test")
     .setColorBackground(color(0, 160, 100))
     .setColorLabel(color(255))
     .setColorActive(color(255,128,0));
     
  cp5.addSlider("test slider").setRange(0,255).moveTo("test");*/
