...
class RGBFilterSequence2 extends Sequence {
	public RGBFilterSequence2(BadTVScene plasmaFX1, int i) {
		// TODO Auto-generated constructor stub
		super(plasmaFX1,i);
	}
	@Override public ArrayList<Mutable> getMutables() {
	...
	@Override public void onStart() {
		...
		for (int i = 0 ; i < random(2,10) ; i++)
			host.host.getSceneForPath("/ImageListScene2").getFilter("ImageListDrawer2").nextMode();*/
		host.getFilter("Plasma").changeParameterValue("colourMode",new Integer ((int)random(0,((BadTVScene)this.host).colourModeCount)));
...
class RGBFilterSequence3 extends Sequence {
	public RGBFilterSequence3(BadTVScene plasmaFX1, int i) {
		// TODO Auto-generated constructor stub
		super(plasmaFX1,i);
	}
	@Override public ArrayList<Mutable> getMutables() {
